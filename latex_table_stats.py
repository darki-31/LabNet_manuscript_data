...
# create tabel header
print("\\begin{tabular}{lrrrcrrrcrrrrrcrrrcrrrcrrr}")

print("\\toprule")
print("\\multicolumn{26}{c}{LabNet latencies}\\\\")
print("\\toprule")
print("\\multicolumn{14}{c}{non optimized} & & \\multicolumn{11}{c}{optimized} \\\\")
print("\\cmidrule{1-14} \\cmidrule{16-26}")
print("& \\multicolumn{3}{c}{id test} & & \\multicolumn{3}{c}{set test} & & \\multicolumn{5}{c}{set and read gpio} & & \\multicolumn{3}{c}{id test} & & \\multicolumn{3}{c}{set test} & & \\multicolumn{3}{c}{set and read gpio} \\\\")
print("\\cmidrule{2-4} \\cmidrule{6-8} \\cmidrule{10-14} \\cmidrule{16-18} \\cmidrule{20-22} \\cmidrule{24-26}")
print("& Rv2  & Rv3 & Rv4  &  & Rv2  & Rv3  & Rv4  &  & Rv2  & Rv3  & Rv4  & 1kHz & max  & & Rv2  & Rv3  & Rv4  &  & Rv2  & Rv3  & Rv4  &  & Rv2  & Rv3  & Rv4  \\\\")

# print C# parameters
print("\\cmidrule{1-14} \\cmidrule{16-26}")
print("\\multicolumn{14}{c}{C\\#} & \\multicolumn{12}{c}{C\\#} \\\\")
print("\\cmidrule{1-14} \\cmidrule{16-26}")
...
print("\\cmidrule{1-14} \\cmidrule{16-26}")
print("\\multicolumn{14}{c}{Python} & \\multicolumn{12}{c}{Python} \\\\")
print("\\cmidrule{1-14} \\cmidrule{16-26}")
