...
print("      {Rv4\\\\{\\scriptsize 1kHz}},%")
print("      {Rv4\\\\{\\scriptsize max}},%")
print("    },")
...
for q in zip(lg, r2n):
    ...
    print("    median=" + ff(q[1]["SetAndRead"].median()) + ",")
    print("    lower quartile=" + ff(q[1]["SetAndRead"].quantile(0.25)) + ",")
    print("    upper quartile=" + ff(q[1]["SetAndRead"].quantile(0.75)) + ",")
    print("    lower whisker=" + ff(q[1]["SetAndRead"].quantile(0.025)) + ",")
    print("    upper whisker=" + ff(q[1]["SetAndRead"].quantile(0.975)) + ",")
