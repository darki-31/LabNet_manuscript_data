...
def create_tex_file():
    ...
    for q in zip(lg, r2n):
        ...
        f.write("    median=" + ff(q[1]["IdTest"].median()) + ",\n")
        f.write("    lower quartile=" + ff(q[1]["IdTest"].quantile(0.25)) + ",\n")
        f.write("    upper quartile=" + ff(q[1]["IdTest"].quantile(0.75)) + ",\n")
        f.write("    lower whisker=" + ff(q[1]["IdTest"].quantile(0.025)) + ",\n")
        f.write("    upper whisker=" + ff(q[1]["IdTest"].quantile(0.975)) + ",\n")
