...
for q in zip(lg, r2n):
    ...
    print("    median=" + ff(q[1]["IdTest"].median()) + ",")
    print("    lower quartile=" + ff(q[1]["IdTest"].quantile(0.25)) + ",")
    print("    upper quartile=" + ff(q[1]["IdTest"].quantile(0.75)) + ",")
    print("    lower whisker=" + ff(q[1]["IdTest"].quantile(0.025)) + ",")
    print("    upper whisker=" + ff(q[1]["IdTest"].quantile(0.975)) + ",")
